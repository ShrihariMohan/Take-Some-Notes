...
<nav class="navbar navbar-expand-lg">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			<span style="font-size: 30px; cursor: pointer; color: blueviolet;"
				  onclick="openNav()">&#9776;</span>
			<div id="mySidenav" class="sidenav">
				<a href="javascript:void(0)" class="closebtn" id="closeNav" onclick="closeNav()">&times;</a>
				<h3 style="color: blueviolet;">Hai ${user.getUserName() }</h3>
				<a style="text-decoration: none; color: black;" id="noteBookView" href="noteBookList.do">NoteBooks</a>
				<a style="text-decoration: none; color: black;" id="listOfNotes" href="listAllNotes.do">Notes</a>
				<a style="text-decoration: none; color: black;" id="editUser" href="editUser.do">Edit User</a>
			</div>
...
<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header text-center">
			<h4 class="modal-title w-100 font-weight-bold"  style="color: blueviolet; font-weight: 100;">Edit Notes</h4>
		</div>
		<div class="modal-body">
			<form action="updateNote.do" method="post">

				<label for="noteBookName" style="color: blueviolet;">Change Notebook Name</label>
				...
				<label for="startDate"  style="color: blueviolet;">Start Date</label> <input type="date"
																							 id="startDate" name="startDate" value="${note.getStartDate()}">

				<label for="endDate"  style="color: blueviolet;">End Date</label> <input type="date"
																						 id="endDate" name="endDate" value="${note.getEndDate()}">

				<label for="remainderDate"  style="color: blueviolet;">Remainder Date</label> <input type="date"
																									 id="remainderDate" name="remainderDate"
																									 value="${note.getRemainderDate()}"><br>
				<label
						for="statusName"  style="color: blueviolet;">Status</label> <select id="statusName"
																							name="statusName">
				<option value="${note.getStatus().getStatusName()}">${note.getStatus().getStatusName()}</option>
				<option value="started"  style="color: blueviolet;">Started</option>
				<option value="inProgress"  style="color: blueviolet;">InProgress</option>
				<option value="complete"  style="color: blueviolet;">Complete</option>
			</select> <label for="tagName"  style="color: blueviolet;">Tag</label> <select id="tagName"
																						   name="tagName" value="${note.getTag().getTagName()}">
				<option value="private">Private</option>
				<option value="public">Public</option>
			</select> <label for="noteDescription"  style="color: blueviolet;">Description</label>
				<textarea id="noteDescription" name="noteDescription"
						  style="height: 150px">${note.getNoteDescription()}</textarea>

				<center>
					<input type="submit" id="submit" value="save" style="margin-top: 5px;">
				</center>
