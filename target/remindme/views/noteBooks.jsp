	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<a id="noteBookView" href="noteBookList.do" style="text-decoration: none; color: black;">NoteBooks</a>
				<a id="listOfNotes" href="listAllNotes.do" style="text-decoration: none; color: black;">Notes</a>
				<a id="editUser" href="editUser.do" style="text-decoration: none; color: black;">Edit User</a>
			</div>

		</ul>
		<ul class="nav navbar-nav navbar-right">
			<li ><a style = "color: blueviolet;" href="addNoteBook.do" data-toggle="modal"
					data-target="#myModal">NEW NOTEBOOK</a></li>
			<li><a style = "color: red  ;" id="logout" href="logout.do"><span
...
<div class="row align-items-center">
	<div class="col">
		<h1 style="text-align: center; color: blueviolet; ">Note Books</h1>
	</div>
	<div class ="col" style="display: flex; justify-content: center;  ">
		<div class="input-group" style="width: 300px; ">
			<input type="text" class="form-control" placeholder="Search Note Books"
				   id="myInput" />
...
<table id="myTable" class="container">
	...
	<c:forEach items="${noteBooks}" var="item">
		<tr style="text-align: center;">
			<td>
				<div class="containerInside" name="myTable">
					<div class="panel panel-default" style="margin: 12px;   box-shadow: 0 8px 6px -6px black;
                        ">
