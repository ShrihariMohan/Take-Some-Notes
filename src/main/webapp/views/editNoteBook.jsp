	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<h3 style="color: blueviolet; text-align: center;">Hai ${user.getUserName() }</h3>
...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header text-center">
			<h4 class="modal-title w-100 font-weight-bold" style="color: blueviolet;">Edit Notebook details</h4>
		</div>
		<div class="modal-body mx-3">
			<form action="updateNoteBook.do" method="post">
				<label for="noteBookName" style="color: blueviolet;">Change Notebook Name</label> <input type="text"
																										 name="noteBookName" id="noteBookName" value="${noteBook.getNoteBookName()}">
