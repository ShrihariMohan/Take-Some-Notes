...
<nav class="navbar navbar-expand-lg bg-light">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right" style="background-color: blueviolet;">
			<li class="dropdown">
				<a  style = "color: blueviolet;" href="#" class="dropdown-toggle glyphicon glyphicon-bell notify"
					...
					<div class="notify-drop-title">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-6">
								<h4 style="color: blueviolet;">Reminder </h4>
							</div>
...
<tr>
	...
	<div class="rows">
		<div class="column left">
			...
			<h2 style="color: blueviolet;">Today Tasks!</h2>
		...
		<div class="column right">
			<div class="row">
				<div class="col-md-6 text-left changes">
					<h1 style="color: blueviolet;">Notes</h1>
				</div>
				<div class="col-md-4">
					<br>
