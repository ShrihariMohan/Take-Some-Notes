	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<h3 style="color: blueviolet; text-align: center;">Hi ${user.getUserName() }</h3>
...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header text-center">
			<h4 class="modal-title w-200 font-weight-bold" style="color: blueviolet;" >Edit User Details</h4>

		</div>
		<div class="modal-body mx-3">
			<form action="updateUser.do" method="post">

				<label for="userName" style="color: blueviolet;">Change Username</label>
				<input type="text" id="userName" name="userName" value="${user.getUserName()}">
				<input type="hidden" name="userId" value="${user.getId()}"> <label
					for="mobileNumber" style="color: blueviolet;" >Change Mobile Number</label> <input type="text"
																									   id="mobileNumber" name="mobileNumber" value="${user.getMobileNumber()}">
				<label for="email" style="color: blueviolet;">Email</label>
				<input type="email" id="email" name="email" value="${user.getEmail()}"> <label
					for="password" style="color: blueviolet;">Password</label>
